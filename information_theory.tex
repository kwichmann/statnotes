...
We might now ask the question: Is there a probability distribution which maximizes differential entropy? It turns out, that for finite mean and variance there is, and it is none other than the normal distribution! This is one of the many ways to characterize the Gaussian.
