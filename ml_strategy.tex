...
\begin{tabular}{c|c|l|}
\cline{2-3}
                                                                                             & General data                                                 & Specific data                                                                       \\ \hline
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Human-level\\ error\end{tabular}}            &                                                              &                                                                                     \\ \hline
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Error on data\\ trained on\end{tabular}}     & \begin{tabular}[c]{@{}c@{}}Training\\ error\end{tabular}     &                                                                                     \\ \hline
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Error on data\\ not trained on\end{tabular}} & \begin{tabular}[c]{@{}c@{}}Training-dev\\ error\end{tabular} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Dev error\\ Test error\end{tabular}} \\ \hline
\end{tabular}
\caption{A generalized view on errors.}
\end{table}
